...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ProductDetailProvider>().loadByName(widget.productName);
    });
  }
                ...
                children: [
                  isNarrow
                      ...
                      : Row(
                        ...
                        children: [
                          Expanded(
                            child: _buildImageSection(provider, displayVariant),
                          ),
            ...
            Expanded(
              child: ElevatedButton(
                onPressed:
                    hasStock
                        ? () {
                          final variant = provider.displayVariant;
                          if (variant == null) return;

                          print(
                            '[ProductDetail] MUA NGAY - Quantity from provider: ${provider.quantity}',
                          );

                          // Set direct buy product in CheckoutProvider
                          context.read<CheckoutProvider>().setDirectBuyProduct(
  ...
  Widget _buildCommentTile(
    ...
    final dateLabel = ProductDetailScreen._commentDateFormat.format(
      comment.createdAt,
    );
