...
class SupplierFormDialog extends StatefulWidget {
  final bool editMode;
  const SupplierFormDialog({super.key, required this.editMode});
...
class _SupplierFormDialogState extends State<SupplierFormDialog> {
  ...
  void initState() {
    ...
    if (widget.editMode) {
      ...
      provider.getSelectedSupplierDetail().then((s) {
        if (!mounted) return;
        if (s != null) {
          setState(() {
            ...
            _contactInfoController.text = s.contactInfo ?? '';
  ...
  Future<void> _handleSubmit(BuildContext context) async {
    ...
    bool success = false;
    if (widget.editMode) {
      final id = provider.selectedSupplierId;
      if (id != null) {
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Điền đầy đủ thông tin bên dưới để ${widget.editMode ? 'chỉnh sửa' : 'tạo'} nhà cung cấp.',
