...
import '../receipt/receipt_form_dialog.dart';
import '../../widgets/confirm_delete_dialog.dart';

class ReceiptToolbar extends StatelessWidget {
  const ReceiptToolbar({super.key});

  @override
  Widget build(BuildContext context) {
    final provider = context.watch<ReceiptProvider>();
    final hasSelection = provider.selectedReceiptId != null;
            ...
            children: [
              if (hasSelection) ...[
                ...
                Tooltip(
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () async {
                      final receipt = await provider.getSelectedReceiptDetail();
