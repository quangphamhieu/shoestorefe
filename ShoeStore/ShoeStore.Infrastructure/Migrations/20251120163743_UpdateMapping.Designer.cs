...
namespace ShoeStore.Infrastructure.Migrations
{
    ...
    [Migration("20251120163743_UpdateMapping")]
            ...
            modelBuilder.Entity("ShoeStore.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2025, 11, 20, 23, 37, 43, 412, DateTimeKind.Local).AddTicks(2621),
                            Email = "admin@gmail.com",
                            FullName = "Admin",
                            Gender = 0,
                            PasswordHash = "AQAAAAIAAYagAAAAEFByDzaV+dbVqAfSJshn5hDeJ1kQ+s8WYQJfRo3sk04MtR9EDW1SbmG5AMMa86qazQ==",
                            Phone = "0345602265",
                            RoleId = (byte)1,
                            StatusId = 1
                        });
